function vol = gquad2d(fun,xlow,xhigh,ylow,yhigh,b1,b2,w1,varargin)
%usage:  vol = gquad2d(fun,xlow,xhigh,ylow,yhigh,bpx,bpy,wfxy,p1,...)
% or
...
% few times).
%
% p1,... are optional parameters for the function fun.
